; ModuleID = 'probe6.a9cb4ec099a0aefb-cgu.0'
source_filename = "probe6.a9cb4ec099a0aefb-cgu.0"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx11.0.0"

; core::f64::<impl f64>::is_subnormal
; Function Attrs: inlinehint uwtable
define internal zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17hba6dd0e2d2e37043E"(double %self) unnamed_addr #0 {
start:
...
define void @_ZN6probe65probe17h9850f1619757d237E() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::is_subnormal
  %_1 = call zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17hba6dd0e2d2e37043E"(double 1.000000e+00)
  ret void
}
